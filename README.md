...
> 
> audio_1.mp3: imagem_1.jpg
> 
> audio_2.mp3: imagem_2.jpg
> 
> audio_3.mp3: imagem_3.jpg
> 
> audio_4.mp3: imagem_4.jpg
> 
> audio_5.mp3: imagem_5.jpg
...
> [!NOTE]
> No código referente à Transferência de Modalidade, a função que toca o áudio foi comentada pois a execução dela estava gerando um erro no GitHub e o arquivo `.ipynb` não estava sendo exibido.
> Apesar disso, para que o áudio seja tocado, é só descomentar a função ao executar o código
...
> [!NOTE]
> In the code related to Modality Transfer, the function that plays the audio was commented out because its execution was causing an error on GitHub, and the `.ipynb` file was not being displayed.
> Nevertheless, to play the audio, simply uncomment the function when running the code.
